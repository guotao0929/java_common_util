...
public class DateUtils {
	...
	public static String StringToString(String date, String oldParttern, String newParttern){
		return DateToString(StringToDate(date, oldParttern), newParttern);
	}
	...
	public static void main(String[] args) {
		SimpleLunarCalendar slc = getSimpleLunarCalendar(new Date());
		System.out.println(slc.getAnimalString());
		System.out.println(slc.getYearString());
	}
}
